 ...
 */
package io.github.catalin87.prism.rulepack.de;
...
import io.github.catalin87.prism.rulepack.de.detector.SteuerIdDetector;
import java.util.List;
import java.util.Set;
import org.jspecify.annotations.NonNull;

/** Germany-focused rule pack with Steuer-ID and IBAN over the universal baseline. */
public final class GermanyRulePack implements PrismRulePack {
