 ...
 */
package io.github.catalin87.prism.rulepack.gb;
...
import io.github.catalin87.prism.rulepack.gb.detector.NhsDetector;
import java.util.List;
import java.util.Set;
import org.jspecify.annotations.NonNull;

/** United Kingdom-focused rule pack with NINO and NHS coverage over the universal baseline. */
public final class UnitedKingdomRulePack implements PrismRulePack {
  ...
  public @NonNull Set<@NonNull String> getActivationAliases() {
    return Set.of("GB", "UK", "GBR", "UNITED_KINGDOM");
  }
