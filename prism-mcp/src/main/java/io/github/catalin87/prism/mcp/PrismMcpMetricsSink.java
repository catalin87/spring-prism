...
/** Extension hook for collecting Prism runtime metrics for MCP integrations. */
public interface PrismMcpMetricsSink {

  String MCP_STDIO_INTEGRATION = "mcp-stdio";
  String MCP_STREAMABLE_HTTP_INTEGRATION = "mcp-streamable-http";

  PrismMcpMetricsSink NOOP = new NoOpPrismMcpMetricsSink();
