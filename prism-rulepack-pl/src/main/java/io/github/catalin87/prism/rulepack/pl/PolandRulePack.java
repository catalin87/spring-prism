 ...
 */
package io.github.catalin87.prism.rulepack.pl;
...
import io.github.catalin87.prism.rulepack.pl.detector.NipDetector;
import java.util.List;
import java.util.Set;
import org.jspecify.annotations.NonNull;

/** Poland-focused rule pack with PESEL and NIP on top of the universal baseline. */
public final class PolandRulePack implements PrismRulePack {
