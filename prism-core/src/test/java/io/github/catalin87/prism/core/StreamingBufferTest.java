...
class StreamingBufferTest {
  ...
  @Test
  void testFragmentedTokenRebuiltFlawlessly() {
    StreamingBuffer buffer = new StreamingBuffer();

    String chunk1 = buffer.processChunk("Hello user, the email associated is <PRIS");
    String chunk2 = buffer.processChunk("M_EMA");
    String chunk3 = buffer.processChunk("IL_u8J>");
